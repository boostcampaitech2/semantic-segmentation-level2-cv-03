...
alb_transform = [
    ...
    #         dict(type='GridDistortion', border_mode=0, p=1.0),
    #         dict(type='RandomCrop', height=300, width=300, p=1.0),
    #         dict(type='RandomGridShuffle', p=0.3),
    #         dict(type='OpticalDistortion', distort_limit=0.5, p=1.0)
    #     ],
    #     p=0.3)
]
...
expr_name = f'UperSwinB22k_All_Notion'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_base_patch4_window7_224_22kto1k.pth')),
    decode_head=dict(
        type='UPerHead',
