...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=imscale, ratio_range=(0.5, 1.25), keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        flip=False,
        transforms=[
            dict(type='Resize', img_scale=imscale, ratio_range=(0.5, 0.75, 1.0, 1.25), keep_ratio=True),
...
expr_name = f'UperSwinB1c_ms_slide512train.py'
