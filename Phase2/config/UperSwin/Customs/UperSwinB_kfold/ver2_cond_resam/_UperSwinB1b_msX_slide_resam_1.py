fold_num = 1
test_root = '/opt/ml/segmentation/input/mmseg/test/'
augs_epoch = 60
...
data = dict(
    ...
    train=dict(
        ...
        ann_dir= '/opt/ml/segmentation/input/data/masks/mode_resampled_conditional',
...
expr_name = f'fold_{fold_num}_os_slide'
