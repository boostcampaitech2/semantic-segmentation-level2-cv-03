...
imsize = 1024
cropsize = 512
imscale = [(x,x) for x in range(512, imsize+1, 128)]
train_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='RandomCrop', height=cropsize, width=cropsize, p=1.0),
        ],
    ),
...
expr_name = f'Swin3-0_5121024_whole_singleTest'
...
model = dict(
    ...
    train_cfg=dict(),
    # test_cfg=dict(mode='slide', crop_size=(cropsize,cropsize), stride=(384,384)))
