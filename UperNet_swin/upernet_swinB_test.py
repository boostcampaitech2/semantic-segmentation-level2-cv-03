...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(512, 512),
        # img_ratios=[0.5, 0.75, 1.0, 1.25, 1.5, 1.75], # best
...
model = dict(
    type='EncoderDecoder',
    pretrained=
    '/opt/ml/segmentation/mmsegmentation/configs/_base_/models/UperSwin/pretrained/Converted_upernet_swin_base_patch4_window12_512x512_160k_ade20k_pretrain_384x384_22K.pth',
    backbone=dict(
